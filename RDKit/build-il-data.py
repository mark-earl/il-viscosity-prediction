...
# Load ions data
ions_data_path = 'RDKit/data/ions.xlsx'
columns_to_skip = ['Chemical name', 'SMILES', 'Faimly', 'M / g/mol']
df_ions = pd.read_excel(ions_data_path, sheet_name='Computed Ions', usecols=lambda x: x not in columns_to_skip)
