...
csv_path = 'generate-fg-graph/gephi/nodes.csv'
output_path = 'generate-fg-graph/gephi/nodes_with_viscosity_group.csv'
...
merged_data = csv_data.merge(
    xlsx_data[['IL ID', 'Viscosity Group']],  # Only need IL ID and Viscosity Group columns
